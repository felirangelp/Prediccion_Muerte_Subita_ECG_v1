                    ...
                    <div class="card">
                        ...
                        <ul class="feature-list">
                            <li><strong>Método 1: Representaciones Dispersas</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Identifica y extrae los patrones fundamentales de la señal ECG mediante algoritmos de representación dispersa, permitiendo capturar las características más relevantes para la clasificación.</span></li>
                            <li><strong>Método 2: Fusión Jerárquica</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Analiza la señal a múltiples escalas temporales y frecuenciales, combinando información de detalles finos (ondas específicas) con patrones generales (morfología completa del ECG) mediante transformadas wavelet y redes neuronales.</span></li>
                            <li><strong>Método 3: Modelo Híbrido</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Integra estratégicamente las fortalezas de ambos métodos anteriores, combinando la precisión de las representaciones dispersas con la robustez del análisis multi-escala, generando un enfoque complementario que mejora la capacidad predictiva.</span></li>
                        </ul>
                    </div>
                    <div class="card">
                        <h3>🎯 Clasificación</h3>
