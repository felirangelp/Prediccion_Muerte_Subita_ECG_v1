                ...
                <div class="pipeline-cards">
                    <div class="card">
                        ...
                        <ul class="feature-list">
                            <li><strong>Filtrado de línea base (0.5 Hz)</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Elimina drift y artefactos de movimiento. <strong>Objetivo:</strong> Señal estable</span></li>
                            <li><strong>Filtrado pasa-bajos (40 Hz)</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Reduce ruido de alta frecuencia. <strong>Objetivo:</strong> Preservar información relevante del ECG</span></li>
                            <li><strong>Normalización Z-score</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Estandariza amplitud entre pacientes. <strong>Objetivo:</strong> Comparabilidad uniforme</span></li>
                            <li><strong>Segmentación en ventanas de 30s</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Divide señales largas en segmentos manejables. <strong>Objetivo:</strong> Procesamiento eficiente</span></li>
                        </ul>
                    </div>
                    <div class="card">
                        <h3>📊 Extracción de Características</h3>
                        <ul class="feature-list">
                            <li><strong>Método 1: Representaciones Dispersas</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Extrae patrones fundamentales mediante algoritmos OMP y k-SVD. <strong>Ventaja:</strong> Alta precisión (94.20%)</span></li>
                            <li><strong>Método 2: Fusión Jerárquica</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Análisis multi-escala con wavelets y TCN. <strong>Ventaja:</strong> Captura detalles finos y patrones globales</span></li>
                            <li><strong>Método 3: Modelo Híbrido</strong><br>
                                <span style="font-size: 0.9em; color: #666;">Combina ambos enfoques. <strong>Ventaja:</strong> Enfoque complementario que integra precisión y robustez</span></li>
                        </ul>
                    </div>
                    <div class="card">
                        <h3>🎯 Clasificación</h3>
